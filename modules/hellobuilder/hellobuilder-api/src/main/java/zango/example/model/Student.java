 ...
 * @generated
 */
@ImplementationClassName("zango.example.model.impl.StudentImpl")
@ProviderType
public interface Student extends StudentModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link zango.example.model.impl.StudentImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
