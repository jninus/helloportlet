 ...
 * @see FooModel
 * @see zango.example.model.impl.FooImpl
 * @see zango.example.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("zango.example.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link zango.example.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
