 ...
 * {@link zango.example.service.impl.StudentLocalServiceImpl} and is the
 ...
 * @see zango.example.service.base.StudentLocalServiceBaseImpl
 * @see zango.example.service.impl.StudentLocalServiceImpl
 * @generated
 */
@ProviderType
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link zango.example.service.impl.StudentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<zango.example.model.Student> getStudents(
		int start, int end) {
	...
	*/
	public static zango.example.model.Student addStudent(
		zango.example.model.Student student) {
	...
	*/
	public static zango.example.model.Student createStudent(long studentId) {
	...
	*/
	public static zango.example.model.Student deleteStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @return the student that was removed
	*/
	public static zango.example.model.Student deleteStudent(
		zango.example.model.Student student) {
		return getService().deleteStudent(student);
	}

	public static zango.example.model.Student fetchStudent(long studentId) {
	...
	* @throws PortalException if a student with the primary key could not be found
	*/
	public static zango.example.model.Student getStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static zango.example.model.Student updateStudent(
		zango.example.model.Student student) {
