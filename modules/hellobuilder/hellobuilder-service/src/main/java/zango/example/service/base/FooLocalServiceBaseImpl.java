...
import zango.example.service.FooLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link zango.example.service.impl.FooLocalServiceImpl}.
 * </p>
 *
...
public abstract class FooLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link zango.example.service.FooLocalServiceUtil} to access the foo local service.
	 */
	 ...
	 */
	public zango.example.service.StudentLocalService getStudentLocalService() {
	...
	public void setStudentLocalService(
		zango.example.service.StudentLocalService studentLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("zango.example.model.Foo",
			fooLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("zango.example.model.Foo");
	}
	...
	@BeanReference(type = zango.example.service.StudentLocalService.class)
	protected zango.example.service.StudentLocalService studentLocalService;
