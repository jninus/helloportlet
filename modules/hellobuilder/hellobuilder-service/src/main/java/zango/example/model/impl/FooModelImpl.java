...
import zango.example.model.FooModel;
import zango.example.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(zango.example.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.zango.example.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(zango.example.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.zango.example.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(zango.example.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.zango.example.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(zango.example.service.util.PropsUtil.get(
				"lock.expiration.time.zango.example.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("zango.example.model.Foo");
